            ...
            <div id="mega-menu-icons-dropdown" class="absolute z-10 hidden w-auto grid grid-cols-2 gap-x-4 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 dark:bg-gray-800 p-1">
              <div class="p-2 pb-0 text-gray-900 md:pb-2 dark:text-white">
                <ul class="space-y-2" aria-labelledby="mega-menu-icons-dropdown-button">
                  ...
                  <li class="px-2 py-1">
                    <a href="../panitikan/antolohiya.html" class="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">Antolohiya</a>
                  </li>
                  <li class="px-2 py-1">
                  ...
                  <li class="px-2 py-1">
                    <a href="../panitikan/banghay-aralin.html" class="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">Banghay Aralin</a>
                  </li>
                  <li class="px-2 py-1">
