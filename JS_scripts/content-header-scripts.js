...
<nav class="bg-white dark:bg-gray-800 dark:border-gray-700 shadow-2xl fixed w-full top-0 z-100 md:px-4" id="navbar">
            <div class="max-w-screen-xl mx-auto flex flex-wrap items-center justify-between p-4">
                ...
                <a href="../index.html" class="flex items-center space-x-3 rtl:space-x-reverse">
                    <span class="self-center text-3xl font-extrabold tracking-tight leading-none text-gray-900 dark:text-white">SIBOL</span>
                </a>
                    <!-- Mobile Menu Button -->
                        ...
                        <div id="mega-menu-icons-dropdown" class="absolute z-10 hidden w-auto grid grid-cols-2 gap-x-4 text-sm bg-white border border-gray-100 rounded-lg shadow-md dark:border-gray-700 dark:bg-gray-800 p-1">
                            ...
                            <div class="p-2 pb-0 text-gray-900 md:pb-2 dark:text-white">
                                <ul class="space-y-2" aria-labelledby="mega-menu-icons-dropdown-button">
                                    ...
                                    <li class="px-2 py-1">
                                        <a href="../panitikan/epiko.html" class="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">Epiko</a>
                                    </li>
                                    <li class="px-2 py-1">
                            ...
                            <div class="p-2 text-gray-900 md:pb-2 dark:text-white">
                                <ul class="space-y-2" aria-labelledby="mega-menu-icons-dropdown-button">
                                    ...
                                    <li class="px-2 py-1">
                                        <a href="../panitikan/awtobiyograpiya.html" class="flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">Awtobiyograpiya</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
